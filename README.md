...
1. samm. Pythoni installimine

2. samm. Laadige alla projekti zip-fail ja pakkige see lahti

3. samm. Pakkige teemade zip-fail lahti

4. samm. Asendage bot.py-failis tokeni väljal "Token_from_BotFather" ja määrake oma roboti token jutumärkides.
